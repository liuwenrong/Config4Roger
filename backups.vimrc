...
" 词典
"au FileType php setlocal dict+=$aVim80Py2/dict/php_funclist.dict
"au FileType css setlocal dict+=$aVim80Py2/dict/css.dict
"au FileType c setlocal dict+=$aVim80Py2/dict/c.dict
"au FileType cpp setlocal dict+=$aVim80Py2/dict/cpp.dict
"au FileType scale setlocal dict+=$aVim80Py2/dict/scale.dict
"au FileType javascript setlocal dict+=$aVim80Py2/dict/javascript.dict
"au FileType html setlocal dict+=$aVim80Py2/dict/javascript.dict
"au FileType html setlocal dict+=$aVim80Py2/dict/css.dict
...
"键盘命令
"""""""""""""""""""""""""""""""""""""""""""""""""""
let mapleader="\<Space>"     "使用的时候要按住, 不放"
...
nmap <leader>q :q<CR>       "退出文件 但不强制退出"
...
nnoremap <C-d> :vert diffsplit      "比较文件  
...
imap <F4> <Esc>:GundoToggle<CR>     "历史记录 版本控制
